 ...
 */
@Entity
@Table(name = "delivery_type", catalog = "mailer", schema = "")
@XmlRootElement
@NamedQueries({
...
public class DeliveryType implements Serializable {
    ...
    @JoinColumn(name = "delivery", referencedColumnName = "delivery_id", nullable = false)
    ...
    public String toString() {
        return "ua.com.codefire.mailer.entity.DeliveryType[ id=" + id + " ]";
    }
