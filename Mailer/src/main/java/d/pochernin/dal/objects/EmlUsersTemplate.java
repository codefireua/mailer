...
@NamedQueries({
    ...
    @NamedQuery(name = "EmlUsersTemplate.findByTemplateOwner", query = "SELECT e FROM EmlUsersTemplate e WHERE e.templateOwner = :templateOwner")})
public class EmlUsersTemplate implements Serializable {
    ...
    private Integer templateOwner;

    public EmlUsersTemplate() {
    }

    public EmlUsersTemplate(String templateName, String templateHeader, String templateBody, Integer templateOwner) {
    ...
    public Integer getTemplateOwner() {
        return templateOwner;
    }

    public void setTemplateOwner(Integer templateOwner) {
        this.templateOwner = templateOwner;
    }
    ...
    public int hashCode() {
        int hash = 3;
        hash = 71 * hash + Objects.hashCode(this.templateId);
        hash = 71 * hash + Objects.hashCode(this.templateName);
        hash = 71 * hash + Objects.hashCode(this.templateHeader);
        hash = 71 * hash + Objects.hashCode(this.templateBody);
        hash = 71 * hash + Objects.hashCode(this.templateOwner);
        return hash;
    }
